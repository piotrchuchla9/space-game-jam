...
export class MenuScene extends Scene {
    ...
    create() {
        this.add.text(360, 640, 'ROCKET BUILDER', {
            fontSize: '48px',
            color: '#ffffff',
...
export class BuildScene extends Scene {
    ...
    create() {
        this.add.text(360, 640, 'BUILD SCENE', {
...
export class FlightScene extends Scene {
    ...
    create() {
        this.add.text(360, 640, 'FLIGHT SCENE', {
            fontSize: '32px', color: '#ffffff', fontFamily: 'monospace'
        }).setOrigin(0.5);
    }
}
...
export class CrashScene extends Scene {
    ...
    create() {
        this.add.text(360, 640, 'CRASH SCENE', {
            fontSize: '32px', color: '#ffffff', fontFamily: 'monospace'
        }).setOrigin(0.5);
    }
}
...
export class InputManager {
    ...
    getState(): InputState {
        const kbThrust = this.keys ? (this.keys.space.isDown || this.keys.w.isDown) : false;
...
export class FlightScene extends Scene {
    ...
    create() {
        ...
        // Ground
        const ground = this.matter.add.rectangle(360, 1250, 720, 100, { isStatic: true, label: 'ground' });
...
export class HUDScene extends Scene {
    ...
    create() {
        ...
        this.fuelBg = this.add.rectangle(570, 50, 130, 16, 0x333333).setOrigin(0, 0.5);
